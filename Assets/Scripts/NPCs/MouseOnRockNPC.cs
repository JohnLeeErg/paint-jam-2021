...
public class MouseOnRockNPC : ExampleNPC
{
    protected override void NodeCreate()
    {
        ...
        Node boat = new Node("The mouse squeaks at you and doesn't move. You don't even know if the mouse would qualify for <color=#F00000>sacrifice</color>.", startNode);
        ...
        cheese.AddOption("Farewell mouse... [Leave Conversation]");

        startNode.AddOption("Uuhh, goodbye mouse. [Leave Conversation]");
    }
