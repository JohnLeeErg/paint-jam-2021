...
public class prayingCultist : ExampleNPC
{
    ...
    {
        startNode = new Node("We pray to our Lord CampBell and his first two messiahs, <color=#7ee7f7>Andy Warhol</color> and <color=#7ee7f7>Paris International</color>.");
        ...
        option15.AddOption("[Carry them to the boat]", transform);
